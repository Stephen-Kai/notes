...
<img src="/assets/images/kbone/Snip20200319_116.png" width="300">

### 3、将 vue 项目编入 Kbone

#### 3.1 改写 kbone-vue 项目 main.js 文件
...
#### 3.4 修改 kbone-vue 项目的 webpack.mp.config.js
...
> 注意：确保 `todos` 在 `entry` 里位于第一个 key，这样 `todos` 对应的页面就是小程序的默认打开页面。

#### 3.5 项目预览效果

在控制台执行 `npm run mp` 或者 `npm run build` 命令，在小程序开发工具中导入 `kbone-vue/dist/mp`, 效果如下：

<img src="/assets/images/kbone/Snip20200319_117.png" width="300">
