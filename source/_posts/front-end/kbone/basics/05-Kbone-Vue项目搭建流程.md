...
export default function createApp() {
  ...
  window.onload = function () {
    document.documentElement.style.fontSize =
      wx.getSystemInfoSync().screenWidth / 16 + "px";
...
<template>
  <div>
    ...
    <div style="margin: 20px;">
      <p style="width: 400px;">
        这段看起来特别特别长的文字宽度是400px，测试测试测试测试测试测试测试测试测试测试测试测试
      </p>
    </div>
    <Footer />
  </div>
...
<img src="/assets/images/kbone/Snip20200325_184.png" width="600">

项目运行效果如下图：

<img src="/assets/images/kbone/Snip20200325_181.png" width="400">
