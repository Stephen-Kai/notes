---
title: RN项目-11-react-navigation
tag: react-native
catogory:
  - front-end
  - react-native
...
在根目录下创建一个 context 目录，在此目录下创建一个 `navigation.js` 文件，内容如下：
...
export { navigationContext, Provider, Consumer };
```
...
##### 2.通过 Context 的 Provider，将 props 递交给后代组件
